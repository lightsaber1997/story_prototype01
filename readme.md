...
본 프로젝트는 MIT 라이선스 하에 배포됩니다.<br>또한, 본 프로젝트는 다음과 같은 세 번째 파티 오픈소스 구성요소 및 모델을 사용하고 있습니다.<br>각 패키지 및 모델의 라이센스 상세 조건은 LICENSE 파일 또는 Hugging Face 모델 카드(Model Card)에서 확인하실 수 있습니다.
